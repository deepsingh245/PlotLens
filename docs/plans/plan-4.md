...
- The Phase 2/3 map-sizing bug (see plan-2.md) never blocked this phase — nothing here depends on the map container's rendered size — and is fixed as of 2026-08-18 regardless.
